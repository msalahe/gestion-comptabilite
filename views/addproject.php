...
<section class="content home">
    ...
    <div class="container-fluid mt--0">
        <form method="post" action="http://localhost/gcomptsonia/projet/ajouterform">


            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Nom Projet</label>
                <input class="form-control" type="text" placeholder="Nom Projet" name="nomp" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="number" placeholder="Estimation des jours " min="0" name="estim" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Pourencatge en %</label>
                <input class="form-control" type="number" placeholder="Pourencatge" min="0" name="pourcen" required>
            </div>
