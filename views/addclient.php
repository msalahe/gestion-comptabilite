...
<section class="content home">
    ...
    <div class="container-fluid mt--0">
        <form method="post" action="http://localhost/gcomptsonia/client/ajouterform">


            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Nom client</label>
                <input class="form-control" type="text" placeholder="Nom client" name="nomC" required>
            </div>


            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Télephone</label>
                <input class="form-control" type="text" placeholder="Télephone" name="tele" required>
            </div>
