        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">ajouter bon commande</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container-fluid mt--0">
        <form method="post" action="http://localhost/gcomptsonia/bc/ajouterform">


            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Nom Bon commande</label>
                <input class="form-control" type="text" placeholder="Nom Projet" name="nomc" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Date de creation</label>
                <input class="form-control" type="date" placeholder="Nom Produit" name="datec" value="<?= date("Y-m-d"); ?>" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Estimation des jours </label>
                <input class="form-control" type="number" placeholder="Estimation des jours " name="estim" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Pourencatge en %</label>
                <input class="form-control" type="number" placeholder="Pourencatge" max="100" name="pourcen" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Budget</label>
                <input class="form-control" type="number" placeholder="Budget" name="budget" required>
            </div>

            <div class="form-group">
                <label for="exampleFormControlSelect1">Projet</label>
                <select class="form-control" id="" name="projet"
                        required>
                    <option></option>
                    <?php foreach ($projet as $dt) { ?>
                        <option value="<?= $dt['idp'] ?>"><?= $dt["nomp"]; ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="" name="etat"
                        required>
                    <option></option>
                    <option value="2">Términer</option>
...
<!-- Jquery Core Js -->
<script src="http://localhost/gcomptsonia/assets/bundles/libscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js ( jquery.v3.2.1, Bootstrap4 js) -->
<script src="http://localhost/gcomptsonia/assets/bundles/vendorscripts.bundle.js"></script> <!-- slimscroll, waves Scripts Plugin Js -->
