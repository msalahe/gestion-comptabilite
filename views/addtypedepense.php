        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">AJOUTER Type depense</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container-fluid mt--0">
        <form method="post" action="http://localhost/gcomptsonia/type/ajouterform">


            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Nom Type depense</label>
                <input class="form-control" type="text" placeholder="Nom Type" name="nomT" required>
