        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">Modifier Avance</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container-fluid mt--0">
        <form method="post" action="http://localhost/gcomptsonia/avance/updateform">

            <div class="form-group">
                <input class="form-control" type="hidden"  name="idv" value="<?= $avance["idv"] ?>" required>
            </div>

            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Date de depense</label>
                <input class="form-control" type="date" placeholder="Nom Produit" name="datep" value="<?php echo date("Y-m-d", strtotime($avance["date"])); ?>" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Avance</label>
                <input class="form-control" type="number" placeholder="Avance"  name="avance" value="<?= $avance["price"] ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="" name="bc"
                        required>
                    <?php foreach ($bcs as $dt){
                        if($dt["idbc"] == $avance["idbc"]) {?>
