    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Les Bon Commandes
                </h2>
            </div>
            <div class="col-lg-5 col-md-6 col-sm-12">
                <?php if (count($bcs) > 0){ ?>
                <a href="http://localhost/gcomptsonia/bc/ajouter/<?= $bcs[0]["idp"]["idp"] ?>">
                    <?php } else { ?>
                    <a href="http://localhost/gcomptsonia/bc/ajouter">
                    ...
                    <ul class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Bon C</a></li>
                    </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="card property_list">
                        <div class="property_image">
                            <img class="img-thumbnail img-fluid"
                                 src="http://localhost/gcomptsonia/assets/images/image-gallery/2.jpg" alt="img">
                        </div>
                        <div class="body">
                            <div class="property-content">
                                <div class="detail">
                                    <h5 class="text-success m-t-0 m-b-0">Date de debut : <?= $pr["date"] ?></h5>
                                    <h4 class="m-t-0"><a href="#" class="col-blue-grey">Nom du Bon C
                                            : <?= $pr["nombc"] ?></a>
                                    </h4>
                                    <h5 class="m-t-0"><a href="#" class="col-blue-grey">Nom Projet
                                            : <?= $pr["idp"]["nomp"] ?></a>
                                    </h5>
                                    <p class="text-muted"><i
                                                class="zmdi zmdi-account-box-mail zmd-fw"></i> <?= $pr["idp"]["nomc"] ?>
                                    </p>

                                    <p class="text-muted m-b-0"><i
                                                class="zmdi zmdi-smartphone-android zmd-fw"></i> <?= $pr["idp"]["telephone"] ?>
                                    </p>
                                    <div class="progress">
                                        <div class="progress-done" data-done="<?= $pr["pourentage"] ?>">
                                            <?= $pr["pourentage"] ?>%
                                        </div>
                                    </div>
                                ...
                                <div class="property-action m-t-15">
                                    <a href="http://localhost/gcomptsonia/projet/infopro/<?= $pr["idbc"] ?>"
                                       title="Square Feet"><i
                                                class="zmdi zmdi-time zmd-fw"></i><span><?= $pr["estimation_temp"] ?> Jours</span></a>
                                    <a href="#" title="Bedroom"><i
                                                class="zmdi zmdi-local-atm zmd-fw"></i><span><?= $pr["bugdet"] ?> Dhs</span></a>
                                    <a href="http://localhost/gcomptsonia/bc/infobc/<?= $pr["idbc"] ?>" title="Bedroom"><i
                                                class="zmdi zmdi-info-outline zmd-fw"></i></a>
                                    <a href="http://localhost/gcomptsonia/bc/update/<?= $pr["idbc"] ?>"
                                       title="Bedroom"><i
