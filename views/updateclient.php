...
<section class="content home">
    ...
    <div class="container-fluid mt--0">
        <form method="post" action="http://localhost/gcomptsonia/client/updateform">

            <div class="form-group">
                <input class="form-control" type="hidden" value="<?= $client["idc"] ?>"  name="idc" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Nom client</label>
                <input class="form-control" type="text" placeholder="Nom client" value="<?= $client["nomc"] ?>" name="nomC" required>
            </div>


            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Télephone</label>
                <input class="form-control" type="text" placeholder="Télephone" value="<?= $client["telephone"] ?>"  name="tele" required>
            </div>
