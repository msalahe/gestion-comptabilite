        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">Modifier bon commande</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container-fluid mt--0">
        <form method="post" action="http://localhost/gcomptsonia/bc/updateform">
            <div class="form-group">
                <input class="form-control" type="hidden" placeholder="Nom Projet" value="<?= $bc["idbc"] ?>"
                       name="idbc" required>
            </div>

            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Nom Bon commande</label>
                <input class="form-control" type="text" placeholder="Nom Projet" value="<?= $bc["nombc"] ?>" name="nomc"
                       required>
            </div>
            <div class="form-group">
                ...
                <input class="form-control" type="date" placeholder="Nom Produit" name="datec"
                       value="<?php echo date("Y-m-d", strtotime($bc["date"])); ?>" required>
            </div>
            <div class="form-group">
                ...
                <input class="form-control" type="number" placeholder="Estimation des jours "
                       value="<?= $bc["estimation_temp"] ?>" name="estim" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Pourencatge en %</label>
                <input class="form-control" type="number" placeholder="Pourencatge" max="100"
                       value="<?= $bc["pourentage"] ?>" name="pourcen" required>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="" name="projet"
                    ...
                    <?php foreach ($projet as $dt) {
                        if ($dt["idp"] == $bc["idp"]) { ?>
                            ...
                            <option value="<?= $dt['idp'] ?>" selected><?= $dt["nomp"]; ?></option>
                        <?php } else { ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="" name="etat"
                    ...
                    <option></option>
                    <?php if ($bc["drap"] == 2) { ?>
                        <option value="2" selected>Términer</option>
