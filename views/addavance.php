        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">AJOUTER Avance</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container-fluid mt--0">
        <form method="post" action="http://localhost/gcomptsonia/avance/ajouterform">



            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Date de depense</label>
                <input class="form-control" type="date" placeholder="Nom Produit" name="datep" value="<?= date("Y-m-d"); ?>" required>
            </div>
            <div class="form-group">
                <label for="example-date-input" class="form-control-label">Avance</label>
                <input class="form-control" type="number" placeholder="Avance "  name="avance" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="" name="bc"
                        required>
                    <?php if(isset($_GET["f"])){?>
                        <option value="<?= $bc["idbc"] ?>" selected><?= $bc["nombc"] ?></option>
                    <?php }else{ foreach ($bc as $dt){ ?>
